            ...
            try:
                ...
                if row_count == -1:
                    ...
                    if output_file is None:
                        print(f"[데이터 없음] {display_date}: 파일 생성 안 함")
                    else:
                        print(
                            f"[데이터 없음] {display_date}: "
